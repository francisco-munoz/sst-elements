...
file_name="gustavsons_gemm_mem.ini"
data_width=4;

rowpointer_a="gustavsons_gemm_rowpointerA.in";
colpointer_a="gustavsons_gemm_colpointerA.in";

rowpointer_b="gustavsons_gemm_rowpointerB.in";
colpointer_b="gustavsons_gemm_colpointerB.in";
