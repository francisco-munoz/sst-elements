...
rowpointer_a="outerproduct/outerproduct_gemm_rowpointerA.in";
colpointer_a="outerproduct/outerproduct_gemm_colpointerA.in";

rowpointer_b="outerproduct/outerproduct_gemm_rowpointerB.in";
colpointer_b="outerproduct/outerproduct_gemm_colpointerB.in";
