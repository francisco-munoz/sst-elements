...
enum multiplierconfig_t {STANDARD, PSUM_GENERATION, FORWARDER}; // For sparseflex_linear
/////
enum Layer_t{CONV, POOL, FC, GEMM, SPARSE_DENSE,bitmapSpMSpM, csrSpMM, outerProductGEMM};
...
/////
enum MemoryController_t{MAERI_DENSE_WORKLOAD, SIGMA_SPARSE_GEMM, MAGMA_SPARSE_DENSE, TPU_OS_DENSE, OUTER_PRODUCT_GEMM};
