...
enum SparsityControllerState{CONFIGURING, DIST_STA_MATRIX, DIST_STR_MATRIX, WAITING_FOR_NEXT_STA_ITER, ALL_DATA_SENT, CONFIGURING_SORTING_PSUMS_DOWN,SENDING_SORT_TREE_DOWN, CONFIGURING_SORTING_PSUMS_UP, RECEIVING_SORT_TREE_UP, EMPTY_ROW_FOUND};
