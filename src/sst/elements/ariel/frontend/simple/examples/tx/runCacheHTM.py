...
def memInit(numCores):
        ...
        for core in range (numCores):
                l1 = sst.Component("l1_cache_%d"%core, "memHierarchy.Cache")
                l1.addParams({                                             
			...
			"htm_support"		: "1",                     
                ...
                l2 = sst.Component("l2_cache_%d"%core, "memHierarchy.Cache")
                l2.addParams({                                             
                        "cache_frequency"       : cacheFrequency,          
                        "cache_size"            : "256KiB",                
                        "cache_line_size"       : cacheLineSize,           
                ...
                tm = sst.Component("tm_cache_%d"%core, "memHierarchy.Cache")
                tm.addParams({
                        "cache_frequency"       : cacheFrequency,
                        "cache_size"            : "8KiB",
                        "cache_line_size"       : cacheLineSize,
		...
		l1_tm_link = sst.Link("l1_tm_link_%d"%core)
       		l1_tm_link.connect((l1, "cache", busLat), (tm, "port2", busLat))
