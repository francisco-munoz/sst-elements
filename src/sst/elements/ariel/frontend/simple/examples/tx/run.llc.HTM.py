...
#                l1_l2_link.connect( (l1, "low_network_0", busLat), (l2, "high_network_0", busLat) ) 
                ...
                l2_htm_link = sst.Link("l2_membus_%d"%core)
                l2_htm_link.connect( (l2, "low_network_0", busLat), (htm, "htm_high_link", freeLat) )

		htm_bus_link = sst.Link("htm_bus_link_%d"%core)
		htm_bus_link.connect( (htm, "htm_low_link", freeLat), (membus, "high_network_%d"%core, busLat) )
