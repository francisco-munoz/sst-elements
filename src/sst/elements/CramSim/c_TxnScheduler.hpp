...
/* Element Library Info */    
            SST_ELI_REGISTER_SUBCOMPONENT(c_TxnScheduler, "CramSim", "c_TxnScheduler", SST_ELI_ELEMENT_VERSION(1,0,0), "Transaction Scheduler", "SST::CramSim::Controller::TxnScheduler")
