...
/* Element Library Info */
        SST_ELI_REGISTER_SUBCOMPONENT(c_TxnConverter, "CramSim", "c_TxnConverter", SST_ELI_ELEMENT_VERSION(1,0,0), "Transaction Converter", "SST::CramSim::Controller::TxnConverter")
