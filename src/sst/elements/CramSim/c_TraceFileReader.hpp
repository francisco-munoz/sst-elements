...
/* Element Library Info */
            SST_ELI_REGISTER_COMPONENT(c_TraceFileReader, "CramSim", "c_TraceFileReader", SST_ELI_ELEMENT_VERSION(1,0,0), "Test Trace file Generator", COMPONENT_CATEGORY_UNCATEGORIZED)
