...
/* Element Library Info */
            SST_ELI_REGISTER_COMPONENT(c_TxnDispatcher, "CramSim", "c_TxnDispatcher", SST_ELI_ELEMENT_VERSION(1,0,0), "Transaction dispatcher", COMPONENT_CATEGORY_UNCATEGORIZED)
