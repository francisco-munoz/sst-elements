...
/* Element Library Info */
        SST_ELI_REGISTER_COMPONENT(c_Dimm, "CramSim", "c_Dimm", SST_ELI_ELEMENT_VERSION(1,0,0), "Test DIMM", COMPONENT_CATEGORY_UNCATEGORIZED)
        ...
        SST_ELI_DOCUMENT_PORTS( {"ctrlLink", "link to controller", { "c_CmdReqEvent" } } )
