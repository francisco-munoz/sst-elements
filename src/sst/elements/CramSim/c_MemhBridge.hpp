...
/* Element Library Info */
        SST_ELI_REGISTER_COMPONENT(c_MemhBridge, "CramSim", "c_MemhBridge", SST_ELI_ELEMENT_VERSION(1,0,0), "Bridge to communicate with MemoryHierarchy", COMPONENT_CATEGORY_UNCATEGORIZED)
        
        SST_ELI_DOCUMENT_PARAMS( {"maxOutstandingReqs", "Maximum number of the outstanding requests"} )
